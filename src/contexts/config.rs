...
impl ConfigContext {
    ...
    pub fn set(&self, config: Config) -> Result<(), GongcheckError> {
        self.inner.set(config.clone());
        self.save(config)?;
        Ok(())
    }

    pub fn set_theme(&self, theme: String) -> Result<(), GongcheckError> {
    ...
    pub fn toggle_view(&self) -> Result<(), GongcheckError> {
        let mut new_config = self.state();
    ...
    pub fn set_view(&self, view: View) -> Result<(), GongcheckError> {
        let mut new_config = self.state();
    ...
    pub fn set_md_input_font_size(&self, size: String) -> Result<(), GongcheckError> {
        let mut new_config = self.state();
    ...
    pub fn increase_font_size(&self) -> Result<(), GongcheckError> {
    ...
    pub fn decrease_font_size(&self) -> Result<(), GongcheckError> {
        let current_size = self.state().md_input_font_size;
        let new_size = match current_size.as_str() {
            "text-xs" => "text-xs",
            "text-sm" => "text-xs",
    ...
    pub fn set_md_preview_font_size(&self, size: String) -> Result<(), GongcheckError> {
        let mut new_config = self.state();
    ...
    pub fn increase_preview_font_size(&self) -> Result<(), GongcheckError> {
    ...
    pub fn decrease_preview_font_size(&self) -> Result<(), GongcheckError> {
        let current_size = self.state().md_preview_font_size;
        let new_size = match current_size.as_str() {
            "prose-sm" => "prose-sm",
            "prose-base" => "prose-sm",
    ...
    pub fn set_data_path(&mut self, path: PathBuf) -> Result<(), GongcheckError> {
        let mut new_config = self.state();
