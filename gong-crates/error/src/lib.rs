...
impl Default for GongcheckError {
    fn default() -> Self {
...
impl From<io::Error> for GongcheckError {
...
impl From<tauri_sys::error::Error> for GongcheckError {
    fn from(tauri_error: tauri_sys::error::Error) -> Self {
        ...
        let ubi_error: GongcheckError = serde_json::from_str(&tauri_error_object_string).unwrap();
...
impl From<StorageError> for GongcheckError {
...
impl From<ron::Error> for GongcheckError {
...
impl From<FromUtf8Error> for GongcheckError {
...
impl From<ron::error::SpannedError> for GongcheckError {
